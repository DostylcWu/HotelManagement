...
<head>
  ...
  <script type="text/javascript" src="user/assets/js/private/comment.js"></script> 
...
<body>
  ...
  <div class="wrapper">
      ...
      <div class="header-bottom">
        <nav class="navbar navbar-universal navbar-custom">
          <div class="container">
            <div class="row">
              <div class="col-lg-3">
                <div class="logo"><a href="/HotelManagement/roomtype.action" class="navbar-brand page-scroll"><img src="user/assets/images/logo/logo.png" alt="logo"/></a></div>
              </div>
              <div class="col-lg-9">
                ...
                <div class="collapse navbar-collapse navbar-main-collapse">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="user/#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Pages <span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="/HotelManagement/comment.action">About Us</a></li>
                        <li><a href="user/contacts.jsp">Contacts</a></li>
                      </ul>
                    </li>
                    <li><a href="user/reserve.jsp">Reservation</a></li>
                    <li><a href="user/#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Rooms <span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="/HotelManagement/roomtype.action">All Rooms</a></li>
                        <li><a href="user/best-rooms-detail.jsp?id=1">Room Detail</a></li>
                      </ul>
                    </li>
                    <li><a href="/HotelManagement/comment.action" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Comment<span class="caret"></span></a>
                      <ul class="dropdown-menu">
                        <li><a href="/HotelManagement/comment.action">All Comment</a></li>
                        <li><a href="user/contacts.jsp">Insert Comment</a></li>
                      </ul>
                    </li>
                    <li><a href="user/reserve.jsp">Purchase</a></li>
                  </ul>
                </div>
              </div>
            </div>
    ...
    <!-- /header -->
    <!-- breadcrumbs -->
    <section class="breadcrumbs" style="background-image: url(user/assets/images/breadcrumbs/about.jpg)">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <ol class="breadcrumb">
              <li><a href="user/#">Home</a><i class="fa fa-angle-right"></i></li>
    ...
    <section class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="about_img"><img class="img-responsive" src="user/assets/images/about/1.jpg" alt=""/></div>
          </div>
          <div class="col-md-6">
            <div class="about_info">
              ...
              <a class="btn btn-default" href="user/contacts.jsp">Contact us</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="testimonials">
      ...
      <div style="width:100%;text-align:center;">
       	<button class="btn btn-default" id="first" onclick="firstPage(1)">首页</button>
     	<button class="btn btn-default" id="last" onclick="lastPage(${pageInfo.pageNum-1 } )">上一页</button>
      	<span id="current">${pageInfo.pageNum }</span>/<span id="total">${pageInfo.pages }</span>
      	<button class="btn btn-default" id="next" onclick="nextPage(${pageInfo.pageNum+1 })">下一页</button>
      	<button class="btn btn-default" id="end" onclick="endPage(${pageInfo.pages })">末页</button>
      </div>
