...
<div class="wrapper">
    ...
    <div id="back" style="background-image: url('assets/img/hotel.jpg');">
        <div id="registerMain">
        ...
        <div  id="registerBody">
            ...
            <div class="bodyParameter">
                ...
                <div class="paraValue" ><input type="text" maxlength="18" onblur="checkIden()" placeholder="it is necessary " id="value6"></div>
