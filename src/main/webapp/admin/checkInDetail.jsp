...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="javascript:;" onclick="window.location.reload()">退房</a></li>
    </ul>
</div>
...
<div class="formbody">
 ...
 <ul class="forminfo">
        ...
        <li><label>已付押金</label><input id="plgmoney" type="text" class="dfinput" disabled="disabled"
                                      value="${maps.checkInBean.pledgeMoney}"/><i></i></li>
        <li><label>已付房费</label><input id="paidmo" type="text" class="dfinput" disabled="disabled"
                                      value="${maps.checkInBean.paidMoney}"/><i></i></li>
        <li><label>房间价格</label><input id="roomprice"type="text" class="dfinput" disabled="disabled"
                                      value="${maps.checkInBean.room.roomType.price}"/><i>今日折扣：
            <c:choose>
                <c:when test="${maps.hotel==null}">今日无优惠
                </c:when>
                <c:otherwise><b id="val">${maps.hotel.value}</b></c:otherwise>
            </c:choose></i></li>
