...
<body>
    ...
    <div class="roomType">
    	<button type="button" class="scbtn" onclick="searchRoom(1,7)">所有房间</button>
        ...
        <button type="button" class="scbtn" onclick="searchRoom(1,5)">海景房</button>
        <button type="button" class="scbtn" onclick="searchRoom(1,6)">桑拿房</button>
