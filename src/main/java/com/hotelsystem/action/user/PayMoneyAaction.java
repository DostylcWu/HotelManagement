...
public class PayMoneyAaction {
	...
	public ModelAndView alipayReturnNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
		...
		ModelAndView mv = new ModelAndView("/HotelManagement/user/alipaySuccess.jsp");
		//——请在这里编写您的程序（以下代码仅作参考）——
		if(signVerified) {
			//商户订单号
	...
	public @ResponseBody String alipayNotifyNotice(HttpServletRequest request, HttpServletRequest response) throws Exception {
