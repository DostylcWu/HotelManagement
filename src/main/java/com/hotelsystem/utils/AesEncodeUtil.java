...
/**
 * @ClassName AesEncodeUtil
 * @Description TODO:加密实现完成
 * @Author Wu Yimin
...
public class AesEncodeUtil {
    ...
    public static final String key="Class33IamIronMan";

    public static void main(String[] args) throws Exception {
        String content = "hotelManagementhotelManagement";
    ...
    public static String aesDecryptByBytes(byte[] encryptBytes, String decryptKey) throws Exception {
        KeyGenerator kgen = KeyGenerator.getInstance("AES");
        /**
         * linux服务器需要修改成SecureRandom.getInstance();否则会报错
         */
        SecureRandom secureRandom = SecureRandom.getInstance("SHA1PRNG");
    ...
    public static String aesDecrypt(String encryptStr) throws Exception {
        return QStringUtil.isEmpty(encryptStr) ? null : aesDecryptByBytes(base64Decode(encryptStr), key);
    }
